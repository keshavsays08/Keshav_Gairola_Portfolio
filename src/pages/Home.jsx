...
export default function Home() {
  ...
  return (
    <section className="min-h-screen flex flex-col bg-[#0d0d0d] px-6 pt-16">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        <div className="max-w-5xl w-full flex flex-col-reverse md:flex-row items-center justify-between gap-16">
          ...
          <div className="flex-1 text-left">
            ...
            <div className="flex items-center gap-2 mb-5 h-10">
              ...
              <span className="text-[#e8e0d4] font-mono text-lg font-semibold">{typed}</span>
          ...
          <div className="flex-shrink-0">
            <div className="relative w-72 h-72 md:w-80 md:h-80">
              ...
              <div className="absolute -inset-3 rounded-2xl border border-[#c9a96e]/07" />
              <img
              ...
              />
              <span className="absolute bottom-3 right-3 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-[#0d0d0d]" title="Open to opportunities" />
            </div>
          </div>
      ...
      {/* Bottom — unique view counter */}
      <div className="relative pb-8 flex justify-center">
        <div className="flex items-center gap-2.5 px-5 py-2 rounded-full border border-[#1f1f1f] bg-[#0d0d0d]">
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#c9a96e] opacity-50"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-[#c9a96e]"></span>
          </span>
          <span className="font-mono text-xs text-[#555]">
            {viewCount === null ? (
              <span className="text-[#333]">counting...</span>
            ) : (
              <>
